(function() {
    ...
    const BeHuman = {
        ...
        preloadCaptchaImages: async function() {
            ...
            try {
                // Use varied queries for people images
                const peopleQueries = ['people', 'person', 'human', 'crowd', 'group of people', 'family', 'friends', 'team'];
                const randomPeopleQuery = peopleQueries[Math.floor(Math.random() * peopleQueries.length)];
                ...
                // Use varied queries for non-people images
                const nonPeopleQueries = ['traffic light', 'crosswalk', 'street', 'building', 'nature', 'animal', 'mountain', 'ocean', 'tree', 'car', 'bicycle', 'architecture', 'landscape', 'city', 'park'];
